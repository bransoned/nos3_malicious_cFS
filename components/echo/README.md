# Echo - NOS3 Component
This repository contains the NOS3 Echo Component.
This includes flight software (FSW), ground software (GSW), simulation, and support directories.

## Component Template
This component template utilizes canned files from the existing [echo component](https://github.com/nasa-itc/echo) to generate a new component to do development in.
...
## Overview
In addition to being used by the template generator, the echo component provides an executable example for the user.  This echo component is a UART device that accepts multiple commands, including requests for telemetry and data.
The available FSW is for use in the core Flight System (cFS) while the GSW supports COSMOS.
A NOS3 simulation is available which includes both echo and 42 data providers.
...
## FSW
Refer to the file [fsw/platform_inc/echo_platform_cfg.h](fsw/platform_inc/echo_platform_cfg.h) for the default
...
<simulator>
    <name>echo_sim</name>
    <active>true</active>
    <library>libecho_sim.so</library>
    <hardware-model>
        <type>ECHO</type>
        <connections>
            <connection><type>command</type>
                <bus-name>command</bus-name>
                <node-name>echo-sim-command-node</node-name>
            </connection>
...
* make
* make checkout
  * Launches NOS Engine, NOS Time Driver, NOS Terminal, Echo Sim, and Echo Checkout
* make stop

# Documentation
If this echo application had an ICD and/or test procedure, they would be linked here.
